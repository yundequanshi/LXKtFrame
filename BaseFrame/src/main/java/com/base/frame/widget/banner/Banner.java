...
public class Banner extends FrameLayout implements OnPageChangeListener {
    ...
    private int mIndicatorScaleType;
    ...
    private void handleTypedArray(Context context, AttributeSet attrs) {
        ...
        mIndicatorScaleType = typedArray.getInt(R.styleable.Banner_indicator_scale_type, 1);
    ...
    private void setScaleType(View imageView, int type) {
    ...
    private void createIndicator() {
        ...
        for (int i = 0; i < count; i++) {
            ...
            setScaleType(imageView, mIndicatorScaleType);
